        ...
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                if self.app.bid == "com.vnggames.cfl.crossfirelegends" {
                    ...
                    self.successMessage = "Eject Crossfire thành công!"
                } else {
                    try injector.restoreLibWebp()
                    self.successMessage = "Eject PUBG thành công!"
                }
    ...
    private func downloadAndReplaceLibWebp() async {
        ...
        do {
            ...
            await MainActor.run {
                ...
                app.reload()
                self.successMessage = "Inject PUBG thành công!"
                self.isSuccessAlertPresented = true
                self.recalculatePlugInCount()
            }
        } catch {
    ...
    private func downloadAndReplaceCrossfire() async {
        ...
        do {
            ...
            await MainActor.run {
                self.isDownloading = false
                app.reload()
                self.successMessage = "Inject Crossfire thành công!"
                self.isSuccessAlertPresented = true
                self.recalculatePlugInCount()
            }
        } catch {
